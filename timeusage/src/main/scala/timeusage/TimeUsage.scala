...
object TimeUsage extends TimeUsageInterface {
  ...
  def classifiedColumns(columnNames: List[String]): (List[Column], List[Column], List[Column]) = {
    val pri = List("t01", "t03", "t11", "t1801","t1803")
    val work = List("t05","t1805")


    columnNames.foldLeft((List.empty[Column],List.empty[Column],List.empty[Column]))((a, column) => {
      if(pri.foldLeft(false)((aa, suffix) => aa || column.startsWith(suffix)))  (col(column) :: a._1,a._2,a._3)
      else if (work.foldLeft(false)((aa, suffix) => aa || column.startsWith(suffix)))  (a._1,col(column) :: a._2,a._3)
      else (a._1,a._2,col(column) :: a._3)
    })
  }
  ...
  def timeUsageGroupedTyped(summed: Dataset[TimeUsageRow]): Dataset[TimeUsageRow] = {
    ...
    summed.groupByKey(rt => (rt.working,rt.sex,rt.age))
      .agg(
